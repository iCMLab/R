...
#         Tutorials for the R/Bioconductor Package GWASTools
#     Instituto de Estudios Celulares y Moleculares - ICM                                #
#                     MADRID, 13/05/2019                                                 #
###########################################################################################
### R code from vignette source 'DataCleaning.Rnw'
### Encoding: ISO8859-1
...
# iluminaio r package basics
'''
genotypeIdatFile <- "C://Users/Usuario/203466360063_R12C01_Red.idat" 
